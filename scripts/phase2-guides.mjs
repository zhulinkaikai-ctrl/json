...
const data = JSON.parse(raw)`,
    ...
    guide({
      ...
      title: 'Unexpected non-whitespace character after JSON: Remove Extra Text',
      description: 'Fix Unexpected non-whitespace character after JSON by removing logs, concatenated objects, or extra data after the first JSON value.',
      summary: 'Unexpected non-whitespace character after JSON means the parser finished one JSON value and then found more non-space text.',
